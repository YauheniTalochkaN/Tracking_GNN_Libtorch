...
{
public:
    EdgeClassificationGNNImpl(const int node_attr_size, const int edge_attr_size, const size_t n_iters = 6, 
                              const int node_hidden_size = 32, const int edge_hidden_size = 32, const int n_heads = 2,
    ...
    torch::Tensor forward(torch::Tensor edge_index, torch::Tensor node_attr, torch::Tensor edge_attr);
...
private:
    ...
    MLP<torch::nn::Tanh, torch::nn::Sigmoid> initial_edge_classification_mlp{nullptr},
                                             ...
                                             final_edge_classification_mlp{nullptr};
