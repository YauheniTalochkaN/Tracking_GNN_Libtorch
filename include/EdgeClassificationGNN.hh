...
{
public:
    EdgeClassificationGNNImpl(const int node_attr_size, const int edge_attr_size, const size_t n_iters_ = 8, 
    ...
    std::pair<torch::Tensor, torch::Tensor> forward(torch::Tensor edge_index, torch::Tensor node_attr, torch::Tensor edge_attr);
